...
export default function Top(props) {
    ...
    useEffect(() => {
        ...
        // idle inuse finished
        setMachineList([
            {id: 0, name: "3D Printer 1", status: "idle", userId: 0, active: true, leftTime: 0, time: 0},
            {id: 1, name: "3D Printer 2", status: "idle", userId: 1, active: true, leftTime: 0, time: 0},
            {id: 2, name: "3D Printer 3", status: "idle", userId: 2, active: true, leftTime: 0, time: 0},
            {id: 3, name: "3D Printer 4", status: "idle", userId: 3, active: true, leftTime: 0, time: 0},
            {id: 4, name: "3D Printer 5", status: "idle", userId: 4, active: true, leftTime: 0, time: 0},
            {id: 5, name: "3D Printer 6", status: "idle", userId: 5, active: true, leftTime: 0, time: 0},
        ]);
    ...
    const handleArrangeMachine = () => {
        const currentUser = waitings.filter((user) => user.id === currentArrangeUser)[0];
        ...
        const machineTime = machineList.filter((machine) => machine.name === arrangeMachineName)[0].time;
    ...
    const showMachineList = () => {
        let idleMachineList = machineList.filter((machine) => machine.status === "idle");
        ...
        <>
            {authority === 1 && (
                <div style={{ width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <Button variant="contained" color="success" style={{ width: "250px", height: "250px", borderRadius: "125px", fontSize: "30px" }}
                            endIcon={<SendIcon />}
                            onClick={() => {
            ...
            {authority === 1 && userRequestFinish && (
                <div style={{ width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", padding: "30px" }}>
                    <h1 style={{ color: "green" }}>預約成功</h1>
                </div>
            )}
            {authority === 0 && (<Element name="title">
            ...
            <Dialog open={arrangeMachineOpen}>
                ...
                <DialogContent>
                    <DialogContentText style={{height: "100px"}}>請填寫欲新增之機台資訊！</DialogContentText>
